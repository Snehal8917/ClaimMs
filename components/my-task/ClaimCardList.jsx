...
const ClaimCardListMyTask = () => {
  ...
  const { data, error, refetch } = useQuery({
    queryKey: ["getClaimsMyTaskList", pageIndex, pageSize, searchString],
    queryFn: async () => {
      setTableLoading(true);
      return getClaimsMyTaskAction({
        page: pageIndex + 1,
        size: pageSize,
        all: false,
        search: searchString,
...
export default ClaimCardListMyTask;
