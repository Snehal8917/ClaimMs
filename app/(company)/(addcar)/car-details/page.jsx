  ...
  return (
    <div>
      <Breadcrumbs>
        ...
        <BreadcrumbItem>Car Details</BreadcrumbItem>
      </Breadcrumbs>
            ...
            <CardContent>
              <div className="flex gap-6 flex-col md:flex-row pt-8">
                ...
                <div className="flex-none md:text-end">
                  <div className="text-4xl font-semibold text-default-900">Car Details #</div>
                  ...
                  <div className="mt-8">
                    <div className="mb-2.5">
                      <span className="mr-12 text-base font-semibold text-default-900">JobCard Date:</span>
